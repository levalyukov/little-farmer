...
var object:Dictionary = {
	"shadow" = load("res://assets/resources/world/big_trees/summer/shadow_0.png"),
	"default" = load("res://assets/resources/world/big_trees/summer/obj_0.png"),
}
	...
	if visible:
		if object.has("shadow"):
			if object["shadow"] is CompressedTexture2D:
				canvas.create_shadow("big_tree_0", object["shadow"], tilemap.local_to_map(position))
			else:
