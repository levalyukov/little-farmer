...
const TEXTURES: Dictionary = {
	0: preload("res://assets/resources/buildings/mailbox/spring/sprite.png"),
	1: preload("res://assets/resources/buildings/mailbox/summer/sprite.png"),
	2: preload("res://assets/resources/buildings/mailbox/autumn/sprite.png"),
	3: preload("res://assets/resources/buildings/mailbox/winter/sprite.png")
}

const HOVERED: Dictionary = {
	0: preload("res://assets/resources/buildings/mailbox/spring/hover.png"),
	1: preload("res://assets/resources/buildings/mailbox/summer/hover.png"),
	2: preload("res://assets/resources/buildings/mailbox/autumn/hover.png"),
	3: preload("res://assets/resources/buildings/mailbox/winter/hover.png")
}
