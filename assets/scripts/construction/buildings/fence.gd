...
@onready var _texture:Dictionary = {
	'spring': {
		'default': load("res://assets/resources/buildings/fence/fence_spring.png"),
		'delete': load("res://assets/resources/buildings/fence/fence_spring_delete.png")
	},
	'summer': {
		'default': load("res://assets/resources/buildings/fence/fence_summer.png"),
		'delete': load("res://assets/resources/buildings/fence/fence_summer_delete.png")
	},
	'autumn': {
		'default': load("res://assets/resources/buildings/fence/fence_autumn.png"),
		'delete': load("res://assets/resources/buildings/fence/fence_autumn_delete.png")
	},
	'winter': {
		'default': load("res://assets/resources/buildings/fence/fence_winter.png"),
		'delete': load("res://assets/resources/buildings/fence/fence_winter_delete.png")
	},
}
...
func moving_sprite() -> void:
	if abs(sprite_coords.x + 16) != _texture[clock.get_season()]["default"].get_size().x:
		sprite_coords.x += 16
	else:
		sprite_coords.x = 0
