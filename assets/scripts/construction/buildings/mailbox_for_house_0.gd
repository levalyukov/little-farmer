...
var object:Dictionary = {
	"shadow" = load("res://assets/resources/buildings/mailbox_for_villages/house_0/shadow.png"),
	"default" = load("res://assets/resources/buildings/mailbox_for_villages/house_0/obj_0.png"),
}
	...
	if visible:
		if object.has("shadow"):
			if object["shadow"] is CompressedTexture2D:
				canvas.create_shadow("barrel_shadow", object["shadow"], tilemap.local_to_map(position))
			else:
