...
var object:Dictionary = {
	"shadow" = load("res://assets/resources/buildings/lamp_post_modern/shadow.png"),
	"idle" = load("res://assets/resources/buildings/lamp_post_modern/object_0.png"),
	"lighting" = load("res://assets/resources/buildings/lamp_post_modern/object_1.png"),
}
	...
	if visible:
		if object.has("shadow"):
			if object["shadow"] is CompressedTexture2D:
				canvas.create_shadow("lamp_post_modern_shadow", object["shadow"], tilemap.local_to_map(position))
			else:
