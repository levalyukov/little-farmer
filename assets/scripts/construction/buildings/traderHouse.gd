...
var object:Dictionary = {
	"caption" = tr("Дом Добрыни"),
	"description" = tr("Дом торговца Добрыни"),
	"shadow" = load("res://assets/resources/buildings/trader_house/shadow.png"),
	"default" = load("res://assets/resources/buildings/trader_house/object_0.png"),
	"hovered" = load("res://assets/resources/buildings/trader_house/object_1.png"),
}
			...
			if object["seasons"].has(season):
				if object["seasons"][season].has("default"):
					if object["seasons"][season]["default"] is CompressedTexture2D:
						...
						self.set_position(tilemap.map_to_local(Vector2i(12,1)))
					else:
