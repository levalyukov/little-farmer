...
func settings_set(values:Dictionary) -> void:
    ...
    movement_type   = int(values["control"]["movement"])    if values.has("control") && values["control"].has("movement")   else 1
