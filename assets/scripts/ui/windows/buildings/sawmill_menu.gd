...
@onready
var logIcon: TextureRect = $Container/Panel/VBox/SlotsMargin/MarginContainer/HBoxContainer/OreContainer/TextureRect
...
@onready
var plankIcon: TextureRect = $Container/Panel/VBox/SlotsMargin/MarginContainer/HBoxContainer/IgnorContainer/TextureRect
@onready
var plankButton: Button = $Container/Panel/VBox/SlotsMargin/MarginContainer/HBoxContainer/IgnorContainer/GetPlank
@onready
var plankAmount: Label = $Container/Panel/VBox/SlotsMargin/MarginContainer/HBoxContainer/IgnorContainer/LabelAmount
@onready
var itemsContainer: GridContainer = $Container/Panel/VBox/InventoryMargin/MarginContainer/ScrollContainer/GridContainer
...
func update_button() -> void:
	if current_node.logAmount > 0 && current_node.logAmount <= inventory.inventory_items[current_node.logID]["amount"]:
