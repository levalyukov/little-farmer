...
@onready var mainLabel:RichTextLabel = get_node('/root/'+main+'/UI/Interactive/DialogWindow/MarginContainer/Panel/VBoxContainer/MainContent/Panel/MainText/VBoxContainer/MarginContainer2/Label')
...
func _on_pressed():
	match type:
		...
		TYPES.OPEN_TRADE:
			dialogWindow.dialogWindowClose()
			trade.open_trade_menu(dialogWindow.npc_id)
		_:
			return
