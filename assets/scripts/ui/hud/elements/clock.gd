...
#		'summer': {
#			'day': [
#				preload('res://assets/sounds/nature/short_audio/summer/day/'),
#			],
#			'night': [
#				preload('res://assets/sounds/nature/short_audio/summer/night/'),
#			]
#		}
#	}

var spring_day_sound = preload('res://assets/sounds/nature/spring_day.ogg')
var spring_night_sound = preload('res://assets/sounds/nature/spring_night.ogg')
const spring_day_sound_end:int = 19
const spring_night_sound_end:int = 6

var summer_day_sound = preload('res://assets/sounds/nature/summer_day.ogg')
var summer_night_sound = preload('res://assets/sounds/nature/summer_night.ogg')
const summer_day_sound_end:int = 19
const summer_night_sound_end:int = 6

var autumn_day_sound = preload('res://assets/sounds/nature/autumn_day.ogg')
var autumn_night_sound = preload('res://assets/sounds/nature/autumn_night.ogg')
const autumn_day_sound_end:int = 19
const autumn_night_sound_end:int = 6

var winter_day_sound = preload('res://assets/sounds/nature/winter_day.ogg')
var winter_night_sound = preload('res://assets/sounds/nature/winter_night.ogg')
